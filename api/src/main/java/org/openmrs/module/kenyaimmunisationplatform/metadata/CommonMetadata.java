...
public class CommonMetadata extends AbstractMetadataBundle {
    ...
    public void install() {
        ...
        install(encounterType("Vaccination", "Collection of information on vaccination given", _EncounterType
                .VACCINATION));
        ...
        install(patientIdentifierType("OpenMRS ID", "Medical Record Number generated by OpenMRS for every patient",
                null,
                null, LuhnMod30IdentifierValidator.class, LocationBehavior.REQUIRED, true, _PatientIdentifierType
                        .OPENMRS_ID));
        install(patientIdentifierType("CWC Number", "Assigned to a child patient when enrolling into the Child "
                ...
                "Should take the format (CWC-MFL code-serial number) e.g CWC-15007-00001", null, LocationBehavior
                        .NOT_USED,
        ...
        install(patientIdentifierType("Patient Clinic Number", "Assigned to the patient at a clinic service (not "
                        + "globally unique)", ".{1,15}", "At most 15 characters long", null, LocationBehavior
                        .NOT_USED, false,
        ...
        install(patientIdentifierType("Permanent Register Number", "Assigned to a patient upon first entry to the "
                        + "permanent register", ".{1,14}", "Accepts alphanumeric values only", null, LocationBehavior
                        .NOT_USED,
        ...
        install(personAttributeType("Citizenship", "Country of which this person is a member", String.class, 0,
                false, 1, _PersonAttributeType.CITIZENSHIP));
        ...
        install(personAttributeType("Mother's Name", "First or last name of this person's mother", String.class, 0,
                false, 5, _PersonAttributeType.MOTHERS_NAME));
        install(personAttributeType("Race", "Group of persons related by common descent or heredity", String.class,
                0, false, 6, _PersonAttributeType.RACE));
    }
}
